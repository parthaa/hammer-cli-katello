  ...
  module ContentViewNameResolvable
    def content_view_resolve_options(options)
      {
        ...
        HammerCLI.option_accessor_name("composite-content-view-name") =>
                                                     options["option_composite_content_view_name"]
      }
    end
    ...
    def all_options
      ...
      if result['option_composite_content_view_name'] &&
        ...
        result['option_composite_content_view_id'] = resolver.content_view_id(
          content_view_resolve_options(result))
        @all_options = result
      end
      result
